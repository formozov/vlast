...
исправлений и модификаций, и доступна по адресу [https://github.com/formozov/vlast](https://github.com/formozov/vlast).  Изменения диаграммы возможны как с помощью отправки запроса автору (*Issue*), так и с помощью копирования репозитория (*Fork*)
