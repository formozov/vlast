...
Репозиторий содержит диаграмму распределения власти в Российской Федереции в машиночитаемом виде. Человекочитаемые версии доступны  в высоком качестве как [pdf](vlast.pdf) (373 KB) и [png](vlast.png) (3.8 MB).
